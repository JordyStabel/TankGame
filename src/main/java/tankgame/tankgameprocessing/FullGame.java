...
public class FullGame extends PApplet {
    ...
    public void setup() {
        ...
        terrain = new Terrain(loadImage("images/test_2.png"), 2); // new Level(image, destructionRes)
...
// Pixels in motion
    class DynamicPixel implements PhysicsObj, RenderObj {
        ...
        int size = 10; // width and height of the pixel
...
// Provides methods for determining solid/empty pixels, and for removing/adding solid pixels
    ...
    static public void main(String args[]) {
        PApplet.main(new String[] { "tankgame.tankgameprocessing.FullGame" });
    }
}